      ...
      <div className=' mt-[80px] ml-[400px] w-[700px] rounded-2xl h-[600px] p-5 bg-[#090941]'>
        <form onSubmit={onsubmited} className=' w-full h-full flex flex-col gap-[25px]'>
            ...
            <div className=' w-[200px] flex items-center gap-5'>
              ...
              <button onClick={()=>navg('/stud')} className=' bg-red-600 rounded-xl p-3 text-white hover:border-solid hover:border-2 hover:border-sky-500'>
              Cancellation
              </button>
            </div>
            <p className='text-white text-[55px] '><span className=' inline-block text-[#06bcef]'>#</span> Add Student information</p>
        </form>
      </div>
