...
const EditTeacher = ({setX,editId,setOz,ozgaruvchi}) => {
// ma'lumotlar1
...
// funksitya1
  let axiosID=async ()=>{
    let res= await axios.get(`http://localhost:3000/teachers/${editId}`)
...
// funksiya2
  let saveEditId=async()=>{
    axios.put(`http://localhost:3000/teachers/${editId}`,change)
    setX(false)
    setOz(ozgaruvchi+1)
  }
