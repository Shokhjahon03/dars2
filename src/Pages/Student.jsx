...
// 
  ...
  return (
    <Fragment>
      <Navbar2 b={b} setB={setB} a={a} setA={setA} searchdat={searchdat} setsearch={setsearch} sdata={sdata}/>
      <Saidbar/>
      <h1 className=' mt-[100px] ml-[400px] text-[80px]'># Students Page</h1>
      {
      ...
      {x?<EditStudents setOz={setOz} ozgaruvchi={ozgaruvchi} setX={setX} editId={editId}/>:null}
    </Fragment>
  )
}
