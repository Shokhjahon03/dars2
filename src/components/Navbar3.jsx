...
const Navbar3 = ({setsearch,searchdat,sdata,a,setA,setB}) => {
      ...
      <nav className=' w-full h-[80px] fixed top-0 left-0 flex justify-center items-center drop-shadow-lg'>
        <div className="container">
          <div className="navbar flex justify-around pl-[150px]">
              ...
              <button onClick={()=>navg('/akjfdhjkfhfhsjdfbjbfj')} className=' bg-[#48ad4a] text-white p-2 rounded-lg hover:bg-lime-500'>
                Admim Settings
              </button>
          </div>
        </div>
